				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<div className="col-span-1 md:col-span-1">
						...
						<p className="text-blue-200 text-sm mb-6">
							Your trusted partner for finding the perfect property. We connect buyers, sellers, and renters with their dream properties.
						</p>
					...
					<div className="col-span-1">
						...
						<ul className="space-y-2">
							...
							<li><Link href="/properties" className="text-blue-200 hover:text-white transition-colors">Properties</Link></li>
							<li><Link href="/agents" className="text-blue-200 hover:text-white transition-colors">Agents</Link></li>
					...
					<div className="col-span-1">
						...
						<ul className="space-y-2">
							<li><Link href="/properties?type=house" className="text-blue-200 hover:text-white transition-colors">Houses</Link></li>
							<li><Link href="/properties?type=apartment" className="text-blue-200 hover:text-white transition-colors">Apartments</Link></li>
							<li><Link href="/properties?type=condo" className="text-blue-200 hover:text-white transition-colors">Condos</Link></li>
							<li><Link href="/properties?type=townhouse" className="text-blue-200 hover:text-white transition-colors">Townhouses</Link></li>
							<li><Link href="/properties?type=land" className="text-blue-200 hover:text-white transition-colors">Land</Link></li>
						</ul>
					</div>
					...
					<div className="col-span-1">
						...
						<ul className="space-y-3">
							<li className="flex items-start">
								...
								<span className="text-blue-200">123 Property Street, Seattle, WA 98101</span>
							</li>
							<li className="flex items-start">
								<svg className="w-5 h-5 mr-2 mt-0.5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
								</svg>
								<span className="text-blue-200">info@idxsolution.com</span>
							</li>
							<li className="flex items-start">
								<svg className="w-5 h-5 mr-2 mt-0.5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							...
							<li className="flex items-start">
								...
								<span className="text-blue-200">Mon-Fri: 9AM-6PM<br />Sat: 10AM-4PM<br />Sun: Closed</span>
							</li>
						</ul>
					</div>
				</div>
